#encoding:utf-8
# Django settings for vieworAdmin project.
...
SECRET_KEY = '0=#h8dn%2$rk9o#)zk5#!o+7uuzoa!qj2w9+xrks$@%#y0&amp;q7^'
...
ROOT_URLCONF = 'vieworAdmin.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'vieworAdmin.wsgi.application'
